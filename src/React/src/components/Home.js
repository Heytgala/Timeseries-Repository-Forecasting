...
const repositories = [
  ...
  },
  {
      ...
      value: "LangChainai-Langchain",
  },
  {
      key: "langchain-ai/langgraph",
      value: "LangChainai-Langgraph",
  },
  {
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            {flag && (githubRepoData?.releaseImageUrls?.all_issues_data_image ? (<div>
              <Divider
                sx={{ borderBlockWidth: "3px", borderBlockColor: "#FFA500" }}
              />
              <Typography variant="h5" component="div" gutterBottom>
              ...
              <div>
                ...
                {/* Render the model loss image Releases  */}
                <img
                  src={githubRepoData?.releaseImageUrls?.model_loss_image_url}
              ...
              <div>
                ...
                {/* Render the LSTM generated image Releases */}
                <img
                  src={
                    githubRepoData?.releaseImageUrls?.lstm_generated_image_url
                  }
              ...
              <div>
                ...
                {/* Render the all issues data image for Releases*/}
                <img
                  src={githubRepoData?.releaseImageUrls?.all_issues_data_image}
              ...
              />
              <Typography variant="h5" component="div" gutterBottom>
                Timeseries Forecasting of Release using Tensorflow and
                Keras LSTM 
              </Typography>
                <p>No Release Data available for the repository </p>
                </div>
            ))}

            {flag && (githubRepoData?.statreleaseImageUrls?.stats_forecast_url ? (<div>
              <Divider
                sx={{ borderBlockWidth: "3px", borderBlockColor: "#FFA500" }}
              />
              <Typography variant="h5" component="div" gutterBottom>
                Timeseries Forecasting of Release using StatsModel
              </Typography>

              <div>
                <Typography component="h4">
                Observation Graph of Release Issues
                </Typography>
                {/* Render the model loss image Pull Request  */}
                <img
                  src={githubRepoData?.statreleaseImageUrls?.stats_observation_url}
                  alt={"Observation Graph of Releases"}
                  loading={"lazy"}
                />
              </div>
              <div>
                <Typography component="h4">
                Time Series Forecasting of Releases
                </Typography>
                {/* Render the LSTM generated image Closed At */}
                <img
                  src={
                    githubRepoData?.statreleaseImageUrls?.stats_forecast_url
                  }
                  alt={"Forecast Components of Releases"}
                  loading={"lazy"}
                />
              </div>
            </div>):(
            ...
            {flag && (githubRepoData?.fpreleaseImageUrls?.fbprophet_forecast_components_url ? (<div>
              <Divider
                sx={{ borderBlockWidth: "3px", borderBlockColor: "#FFA500" }}
              />
              <Typography variant="h5" component="div" gutterBottom>
                Timeseries Forecasting of Releases using Facebook/Prophet
              </Typography>

              <div>
                <Typography component="h4">
                  Forecast of Releases
                </Typography>
                {/* Render the model loss image Closed AT  */}
                <img
                  src={githubRepoData?.fpreleaseImageUrls?.fbprophet_forecast_url}
                  alt={"Forecast of Releases"}
                  loading={"lazy"}
                />
              </div>
              <div>
                <Typography component="h4">
                Forecast Components of Releases
                </Typography>
                {/* Render the LSTM generated image Closed At */}
                <img
                  src={
                    githubRepoData?.fpreleaseImageUrls?.fbprophet_forecast_components_url
                  }
                  alt={"Forecast Components of Releases"}
                  loading={"lazy"}
                />
              ...
              />
              <Typography variant="h5" component="div" gutterBottom>
                Timeseries Forecasting of Release using Facebook/Prophet
              </Typography>
                <p>No Release Data available for the repository </p>
                </div>
            ))}
            ...
            {flag && (<div>
              ...
              <div>
                ...
                {/* Render the model loss image Contributors  */}
                <img
                  src={githubRepoData?.contributorImageUrls?.model_loss_image_url}
              ...
              <div>
                ...
                {/* Render the LSTM generated image Contributors */}
                <img
                  src={
                    githubRepoData?.contributorImageUrls?.lstm_generated_image_url
                  }
              ...
              <div>
                ...
                {/* Render the all issues data image for Contributors*/}
                <img
                  src={githubRepoData?.contributorImageUrls?.all_issues_data_image}
            ...
            {flag && (<div>
              ...
              <div>
                <Typography component="h4">
                Observation Graph of Contributors
                </Typography>
                {/* Render the model loss image Contributors  */}
                <img
                  src={githubRepoData?.statcontributorImageUrls?.stats_observation_url}
                  alt={"Observation Graph of Contributors"}
                  loading={"lazy"}
                />
              </div>
              <div>
                <Typography component="h4">
                Time Series Forecasting of Contributors
                </Typography>
                {/* Render the LSTM generated image Closed At */}
                <img
                  src={
                    githubRepoData?.statcontributorImageUrls?.stats_forecast_url
                  }
                  alt={"Forecast Components of Contributors"}
                  loading={"lazy"}
                />
              </div>
            </div>)}
            ...
            {flag && (<div>
              ...
              />
              <Typography variant="h5" component="div" gutterBottom>
                Timeseries Forecasting of Contributors using Facebook/Prophet
              </Typography>

              <div>
                <Typography component="h4">
                  Forecast of Contributors
                </Typography>
                {/* Render the model loss image Closed AT  */}
                <img
                  src={githubRepoData?.fpcontributorImageUrls?.fbprophet_forecast_url}
                  alt={"Forecast of Contributors"}
                  loading={"lazy"}
                />
              </div>
              <div>
                <Typography component="h4">
                Forecast Components of Contributors
                </Typography>
                {/* Render the LSTM generated image Closed At */}
                <img
                  src={
                    githubRepoData?.fpcontributorImageUrls?.fbprophet_forecast_components_url
                  }
                  alt={"Forecast Components of Contributors"}
                  loading={"lazy"}
                />
            ...
            {flag && (<div>
              ...
              <div>
                ...
                {/* Render the model loss image Branches  */}
                <img
                  src={githubRepoData?.branchImageUrls?.model_loss_image_url}
              ...
              <div>
                ...
                {/* Render the LSTM generated image Branches */}
                <img
                  src={
                    githubRepoData?.branchImageUrls?.lstm_generated_image_url
                  }
              ...
              <div>
                ...
                <img
                  src={githubRepoData?.branchImageUrls?.all_issues_data_image}
            ...
            {flag && (<div>
              ...
              <div>
                <Typography component="h4">
                Observation Graph of Branches
                </Typography>
                {/* Render the model loss image Pull Request  */}
                <img
                  src={githubRepoData?.statbranchImageUrls?.stats_observation_url}
                  alt={"Observation Graph of Branches"}
                  loading={"lazy"}
                />
              </div>
              <div>
                <Typography component="h4">
                Time Series Forecasting of Branches
                </Typography>
                {/* Render the LSTM generated image Closed At */}
                <img
                  src={
                    githubRepoData?.statbranchImageUrls?.stats_forecast_url
                  }
                  alt={"Forecast Components of Branches"}
                  loading={"lazy"}
                />
              </div>
            </div>)}
            ...
            {flag && (<div>
              ...
              />
              <Typography variant="h5" component="div" gutterBottom>
                Timeseries Forecasting of Branches using Facebook/Prophet
              </Typography>

              <div>
                <Typography component="h4">
                  Forecast of Branches
                </Typography>
                {/* Render the model loss image Closed AT  */}
                <img
                  src={githubRepoData?.fpbranchImageUrls?.fbprophet_forecast_url}
                  alt={"Forecast of Branches"}
                  loading={"lazy"}
                />
              </div>
              <div>
                <Typography component="h4">
                Forecast Components of Branches
                </Typography>
                {/* Render the LSTM generated image Closed At */}
                <img
                  src={
                    githubRepoData?.fpbranchImageUrls?.fbprophet_forecast_components_url
                  }
                  alt={"Forecast Components of Branches"}
                  loading={"lazy"}
                />
